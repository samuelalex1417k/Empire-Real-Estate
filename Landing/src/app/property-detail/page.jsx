                    ...
                    <div className="lg:w-2/3 md:w-1/2 md:p-4 px-3">
                        ...
                        <ul className="py-6 flex items-center list-none">
                            <li className="flex items-center lg:me-6 me-4">
                                <LiaCompressArrowsAltSolid className=" lg:text-3xl text-2xl me-2 text-[#947e03]"/>
                                <span className="lg:text-xl">8000sqf</span>
                            </li>

                            <li className="flex items-center lg:me-6 me-4">
                                <LuBedDouble className="lg:text-3xl text-2xl me-2 text-[#947e03]"/>
                                <span className="lg:text-xl">4 Beds</span>
                            </li>

                            <li className="flex items-center">
                                <LuBath className="lg:text-3xl text-2xl me-2 text-[#947e03]"/>
                    ...
                    <div className="lg:w-1/3 md:w-1/2 md:p-4 px-3 mt-8 md:mt-0">
                        <div className="sticky top-20">
                            <div className="rounded-md bg-slate-50 dark:bg-slate-800 shadow-sm dark:shadow-gray-800">
                                <div className="p-6">
                                    ...
                                    <div className="flex justify-between items-center mt-4">
                                        ...
                                        <span className="bg-[#947e03]/10 text-[#947e03] text-sm px-2.5 py-0.75 rounded h-6">For Sale</span>
                                    </div>
                                ...
                                <div className="flex">
                                    <div className="p-1 w-1/2">
                                        <Link href="#" className="py-2 px-5 inline-block font-semibold tracking-wide border align-middle duration-500 text-base text-center bg-[#947e03] hover:bg-indigo-700 border-[#947e03] hover:border-indigo-700 text-white rounded-md w-full">Book Now</Link>
                                    </div>
                                    <div className="p-1 w-1/2">
                                        <Link href="#" className="py-2 px-5 inline-block font-semibold tracking-wide border align-middle duration-500 text-base text-center bg-[#947e03] hover:bg-indigo-700 border-[#947e03] hover:border-indigo-700 text-white rounded-md w-full">Offer Now</Link>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="mt-12 text-center">
                                ...
                                <div className="mt-6">
                                    <Link href="/contact-one" className="py-2 px-5 inline-flex font-semibold tracking-wide align-middle transition duration-500 ease-in-out text-base text-center bg-transparent hover:bg-[#947e03] border border-[#947e03] text-[#947e03] hover:text-white rounded-md"><FiPhone className="me-1 text-lg"/>Contact us</Link>
                                </div>
                            </div>
                        </div>
                    </div>
