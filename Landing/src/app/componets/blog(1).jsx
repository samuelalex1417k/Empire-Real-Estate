        ...
        <div className={className}>
            <div className="grid md:grid-cols-12 grid-cols-1 items-center">
                <div className="md:col-span-6">
                    <h6 className="text-[#947e03] text-sm font-bold uppercase mb-2">Blogs</h6>
