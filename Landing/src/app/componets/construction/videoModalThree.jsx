...
export default function VideoModalThree(){
    ...
    return(
        <>
        <Link href="#" onClick={()=>setOpen(!isOpen)} scroll={false} className="lightbox size-20 rounded-full shadow-lg dark:shadow-gray-800 inline-flex items-center justify-center bg-white dark:bg-slate-900 text-[#947e03] mx-auto mt-10">
