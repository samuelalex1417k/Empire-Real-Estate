...
export default function VideoModal(){
    ...
    return(
        ...
        <div className="lg:col-span-4 md:col-span-5 md:text-center md:order-2 order-1">
            <Link href="#" onClick={()=>setOpen(!isOpen)} scroll={false} className="lightbox lg:size-24 size-20 rounded-full shadow-lg dark:shadow-gray-800 inline-flex items-center justify-center bg-white hover:bg-[#947e03] text-[#947e03] hover:text-white duration-500 ease-in-out mx-auto">
