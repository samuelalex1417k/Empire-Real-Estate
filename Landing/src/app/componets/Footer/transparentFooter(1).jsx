                                    ...
                                    <div className="lg:col-span-3 md:col-span-4">
                                        ...
                                        <form>
                                            <div className="grid grid-cols-1">
                                                ...
                                                <button type="submit" id="submitsubscribe" name="send" className="py-2 px-5 inline-block font-semibold tracking-wide border align-middle duration-500 text-base text-center bg-[#947e03] hover:bg-indigo-700 border-[#947e03] hover:border-indigo-700 text-white rounded-md">Subscribe</button>
                                            </div>
                                        </form>
                                    </div>
                                </div>
