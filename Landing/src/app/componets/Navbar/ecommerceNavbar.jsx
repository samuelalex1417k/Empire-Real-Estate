            ...
            <div className="container relative">
                ...
                <ul className="buy-button list-none space-x-1 mb-0 flex items-center justify-center " style={{height:"74px"}}>
                    ...
                    <li className="dropdown inline-block relative">
                        <button onClick={()=>setIsCart(!isCart)}  data-dropdown-toggle="dropdown" className="dropdown-toggle size-9 inline-flex items-center justify-center tracking-wide align-middle duration-500 text-base text-center rounded-full bg-[#947e03] hover:bg-indigo-700 border border-[#947e03] hover:border-indigo-700 text-white" type="button">
                        ...
                        {isCart ?
                             ...
                             <ul className="py-3 text-start" aria-labelledby="dropdownDefault">
                                 ...
                                 <li className="py-1.5 px-4 space-x-1">
                                     <Link href="#" className="py-[5px] px-4 inline-block font-semibold tracking-wide align-middle transition duration-500 ease-in-out text-sm text-center rounded-md bg-[#947e03] hover:bg-indigo-700 border border-[#947e03] hover:border-indigo-700 text-white">View Cart</Link>
                                     <Link href="#" className="py-[5px] px-4 inline-block font-semibold tracking-wide align-middle transition duration-500 ease-in-out text-sm text-center rounded-md bg-[#947e03] hover:bg-indigo-700 border border-[#947e03] hover:border-indigo-700 text-white">Checkout</Link>
                    ...
                    <li className="inline-block ms-1">
                        <Link href="#" onClick={()=>setShowModel(!showModal)}   className="size-9 inline-flex items-center justify-center tracking-wide align-middle duration-500 text-base text-center rounded-full bg-[#947e03] hover:bg-indigo-700 border border-[#947e03] hover:border-indigo-700 text-white" data-modal-toggle="ContactUs">
                        ...
                        <div className="relative w-full h-auto max-w-lg p-4">
                            <div className="relative bg-white dark:bg-slate-900 rounded-lg shadow-sm dark:shadow-gray-800">
                                ...
                                <div className="p-6 py-10 text-center">
                                    ...
                                    <Link href="#" className="py-[5px] px-4 inline-block font-semibold tracking-wide align-middle transition duration-500 ease-in-out text-sm text-center bg-transparent hover:bg-[#947e03] border border-[#947e03] text-[#947e03] hover:text-white rounded-md mt-2">Create a new wishlist</Link>
                                </div>
                            </div>
                        </div>
                    </div>:""}
                    ...
                    <li className="dropdown inline-block relative ms-1">
                        ...
                        {isAccount ? <div className="dropdown-menu absolute end-0 m-0 mt-4 z-10 w-44 rounded-md bg-white dark:bg-slate-900 shadow-sm dark:shadow-gray-800 ">
                            <ul className="py-2 text-start" aria-labelledby="dropdownDefault">
                                <li>
                                    <Link href="/shop-account" className="flex items-center py-1.5 px-4 hover:text-[#947e03]"><AiOutlineUser className="me-2"/> Account</Link>
                                </li>
                                <li>
                                    <Link href="/shop-cart" className="flex items-center py-1.5 px-4 hover:text-[#947e03]"><PiNoteDuotone className="align-middle me-1"/> Order History</Link>
                                </li>
                                <li>
                                    <Link href="/shop-checkout" className="flex items-center py-1.5 px-4 hover:text-[#947e03]"><BsArrowDownCircle className="align-middle text-sm me-1"/> Download</Link>
                                </li>
                                <li className="border-t border-gray-100 dark:border-gray-800 my-2"></li>
                                <li>
                                    <Link href="/auth-login" className="flex items-center py-1.5 px-4 hover:text-[#947e03]"><LiaSignOutAltSolid className="align-middle me-2 w-5 h-5"/> Logout</Link>
                                </li>
                            </ul>
                        </div> :""}
