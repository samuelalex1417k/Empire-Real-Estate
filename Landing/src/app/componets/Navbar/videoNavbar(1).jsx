                ...
                <div className="container relative">
                    ...
                    <ul className="buy-button list-none space-x-1 mb-0">
                        <li className="inline ps-1 mb-0">
                            <Link href="#" className="size-9 inline-flex items-center justify-center tracking-wide align-middle duration-500 text-base text-center rounded-full bg-[#947e03] hover:bg-indigo-700 border border-[#947e03] hover:border-indigo-700 text-white"><Icon.ShoppingCart className="size-4"></Icon.ShoppingCart></Link>
                        </li>
                    </ul>
