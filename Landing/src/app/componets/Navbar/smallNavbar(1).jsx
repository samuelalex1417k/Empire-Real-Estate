        ...
        <div className="container relative">
            ...
            <ul className="buy-button list-none space-x-1 mb-0">
                <li className="inline mb-0">
                    <Link href="#" className="size-9 inline-flex items-center justify-center tracking-wide align-middle duration-500 text-base text-center rounded-full bg-[#947e03]/5 hover:bg-[#947e03] border border-[#947e03]/10 hover:border-[#947e03] text-[#947e03] hover:text-white"><Icon.Settings className="size-4"></Icon.Settings></Link>
                </li>

                <li className="inline ps-1 mb-0">
                <Link href="https://1.envato.market/techwind-next" target="_blank" className="size-9 inline-flex items-center justify-center tracking-wide align-middle duration-500 text-base text-center rounded-full bg-[#947e03] hover:bg-indigo-700 border border-[#947e03] hover:border-indigo-700 text-white"><Icon.ShoppingCart className="size-4"></Icon.ShoppingCart></Link>
                </li>
            </ul>
                    ...
                    <div className="relative bg-white dark:bg-slate-900 rounded-lg shadow-sm dark:shadow-gray-800">
                        ...
                        <div className="p-6 text-center">
                            <form>
                                    ...
                                    <div className="mb-5">
                                        <div className="text-start">
                                            ...
                                            <div className="form-icon relative mt-2">
                                                ...
                                                <input name="subject" id="subject" className="form-input ps-11 w-full py-2 px-3 h-10 bg-transparent dark:bg-slate-900 dark:text-slate-200 rounded outline-none border border-gray-200 focus:border-[#947e03] dark:border-gray-800 dark:focus:border-[#947e03] focus:ring-0" placeholder="Subject :" />
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <button type="submit" id="submit" name="send" className="py-2 px-5 font-semibold tracking-wide border align-middle duration-500 text-base text-center bg-[#947e03] hover:bg-indigo-700 border-[#947e03] hover:border-indigo-700 text-white rounded-md justify-center flex items-center">Send Message</button>
                            </form>
                        </div>
                    </div>
                </div>
