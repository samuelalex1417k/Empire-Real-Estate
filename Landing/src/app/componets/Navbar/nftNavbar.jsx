                ...
                <ul className="buy-button list-none space-x-1 mb-0">
                    ...
                    <li className="inline-block mb-0">
                        <div className="form-icon relative">
                            ...
                            <input type="text" className="form-input sm:w-44 w-28 ps-10 py-2 px-3 h-10 bg-transparent dark:bg-slate-900 dark:text-slate-200 rounded-3xl outline-none border border-gray-200 focus:border-[#947e03] dark:border-gray-800 dark:focus:border-[#947e03] focus:ring-0 bg-white" name="s" id="searchItem" placeholder="Search..." />
                        </div>
                    </li>

                    <li className="inline-block ps-1 mb-0">
                        <Link href="#" id="connectWallet" onClick={metamask}  className="size-9 inline-flex items-center justify-center tracking-wide align-middle duration-500 text-base text-center rounded-full bg-[#947e03] hover:bg-indigo-700 border border-[#947e03] hover:border-indigo-700 text-white"><BiWallet/></Link>
                    </li>

                    <li className="dropdown inline-block relative ps-1">
                        <button onClick={() => openDropdown(!isDropdown)}  data-dropdown-toggle="dropdown" className="dropdown-toggle size-9  items-center justify-center tracking-wide align-middle duration-500 text-base text-center rounded-full bg-[#947e03] hover:bg-indigo-700 border border-[#947e03] hover:border-indigo-700 text-white inline-flex" type="button">
                        ...
                        <div className= {`dropdown-menu absolute end-0 m-0 mt-4 z-10 w-48 rounded-md overflow-hidden bg-white dark:bg-slate-900 shadow-sm dark:shadow-gray-800  ${isDropdown ? 'hidden' : 'block'}`}>
                            ...
                            <div className="relative">
                                <div className="py-8 bg-gradient-to-tr from-[#947e03] to-red-600"></div>
                            ...
                            <div className="mt-10 px-4">
                                ...
                                <div className="flex items-center justify-between">
                                    ...
                                    <Link href="#!" className="text-[#947e03]"><AiOutlineCopy/></Link>
                                </div>
                            </div>

                            <div className="mt-4 px-4">
                                <h5 className="text-[15px]">Balance: <span className="text-[#947e03] font-semibold">0.00045ETH</span></h5>
                            </div>

                            <ul className="py-2 text-start">
                                <li>
                                    <Link href="/nft-creator-profile" className="flex items-center text-[14px] font-semibold py-1.5 px-4 hover:text-[#947e03]"><AiOutlineUser className="me-2"/> Profile</Link>
                                </li>
                                <li>
                                    <Link href="/nft-creator-profile-edit" className="flex items-center text-[14px] font-semibold py-1.5 px-4 hover:text-[#947e03]"><IoSettingsOutline className="me-1 w-5"/> Settings</Link>
                                </li>
                                <li className="border-t border-gray-100 dark:border-gray-800 my-2"></li>
                                <li>
                                    <Link href="/auth-login" className="flex items-center text-[14px] font-semibold py-1.5 px-4 hover:text-[#947e03]"><LiaSignOutAltSolid className="me-2 size-4"/> Logout</Link>
                                </li>
                            </ul>
                        </div>
                    </li>
