...

            {
                navClass !== 'nav-light' ? <ul className={`buy-button list-none space-x-1 mb-0`} >
                        <li className="inline mb-0">
                            <Link href="#" className="size-9 inline-flex items-center justify-center tracking-wide align-middle duration-500 text-base text-center rounded-full bg-[#947e03]/5 hover:bg-[#947e03] border border-[#947e03]/10 hover:border-[#947e03] text-[#947e03] hover:text-white"><LuSettings className="size-4" /></Link>
                        </li>
                    ...
                    <li className="inline mb-0">
                        <Link href="#">
                            <span className="login-btn-primary"><span className="size-9 inline-flex items-center justify-center tracking-wide align-middle transition duration-500 ease-in-out text-base text-center rounded-full bg-[#947e03]/5 hover:bg-[#947e03] border border-[#947e03]/10 hover:border-[#947e03] text-[#947e03] hover:text-white"><LuSettings className="size-4" /></span></span>
                    ...
                    <li className="inline ps-1 mb-0">
                        <Link href="https://1.envato.market/techwind-next" target="_blank">
                            <div className="login-btn-primary"><span className="size-9 inline-flex items-center justify-center tracking-wide align-middle transition duration-500 ease-in-out text-base text-center rounded-full bg-[#947e03] hover:bg-indigo-700 border border-[#947e03] hover:border-indigo-700 text-white"><BsCart3 className="size-4" /></span></div>
