                            ...
                            <div className="grid grid-cols-12 gap-3">
                                ...
                                <div className="col-span-12">
                                    ...
                                    <div className="relative mt-2">
                                        ...
                                        <input type="text" className="form-input pe-12 w-full py-2 px-3 h-10 bg-transparent dark:bg-slate-900 dark:text-slate-200 rounded outline-none border border-gray-200 focus:border-[#947e03] dark:border-gray-800 dark:focus:border-[#947e03] focus:ring-0" defaultValue="c12b001a15f9bd46ef1c6551386c" required/>
                                    </div>
                                </div>
                            </div>
                        </form>
