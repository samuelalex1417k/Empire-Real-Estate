                                        ...
                                        return(
                                            <tr key={index}>
                                                ...
                                                <td className="text-end border-t border-gray-100 dark:border-gray-800 p-4">
                                                    ...
                                                    {item.status === 'New Order' ?   <span className="bg-[#947e03]/10 dark:bg-[#947e03]/20 border border-[#947e03]/10 dark:border-[#947e03]/20 text-[#947e03] text-[12px] font-bold px-2.5 py-0.5 rounded h-5 ms-1">{item.status}</span> : ''}
