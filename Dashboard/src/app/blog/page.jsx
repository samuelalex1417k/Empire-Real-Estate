...
export default function Page() {
  ...
  const handleDelete = async () => {
    ...
    try {
      ...
      const res = await fetch(`http://localhost:8000/api/blogs/${deleteId}/`, {
        method: "DELETE",
        headers: {
      ...
      setDeleteError("Error deleting blog. Please try again.");
    }
  };
  ...
  return (
    ...
    <div className="container-fluid relative px-3" ref={containerRef}>
        <div className="layout-specing">
          ...
          {loading ? (
            <p className="mt-6 text-center">Loading Blogs...</p>
          ) : error ? (
