            ...
            <div className="layout-specing">
                <div className="md:flex justify-between items-center">
                    ...
                    <ul className="tracking-[0.5px] inline-flex items-center sm:mt-0 mt-3">
                        ...
                        <li className="inline-block capitalize text-[14px] font-bold text-[#947e03] dark:text-white" aria-current="page">Components</li>
                    </ul>
                </div>
                                ...
                                <div className="grid grid-cols-1 gap-[30px]">
                                        ...
                                        <div className="p-5 border-t border-gray-100 dark:border-slate-800">
                                            <ul className="list-none">
                                                <li className="inline-block m-0.5">
                                                    <Link href="" className="py-2 px-5 inline-block font-semibold tracking-wide border align-middle duration-500 text-base text-center bg-[#947e03] hover:bg-indigo-700 border-[#947e03] hover:border-indigo-700 text-white rounded-md">Indigo</Link>
                                                </li>
                                    ...
                                    <div className="shadow-sm dark:shadow-slate-800 rounded bg-white dark:bg-slate-900">
                                        ...
                                        <div className="p-5 border-t border-gray-100 dark:border-slate-800">
                                            <ul className="list-none">
                                                <li className="inline-block m-0.5">
                                                    <Link href="" className="py-2 px-5 inline-block font-semibold tracking-wide border align-middle duration-500 text-base text-center bg-[#947e03] hover:bg-indigo-700 border-[#947e03] hover:border-indigo-700 text-white rounded-full">Indigo</Link>
                                                </li>
                                    ...
                                    <div className="shadow-sm dark:shadow-slate-800 rounded bg-white dark:bg-slate-900">
                                        ...
                                        <div className="p-5 border-t border-gray-100 dark:border-slate-800">
                                            <ul className="list-none">
                                                <li className="inline-block m-0.5">
                                                    <Link href="" className="py-2 px-5 inline-block font-semibold tracking-wide border align-middle duration-500 text-base text-center bg-transparent hover:bg-[#947e03] border-[#947e03] text-[#947e03] hover:text-white rounded-md">Indigo</Link>
                                                </li>
                                    ...
                                    <div className="shadow-sm dark:shadow-slate-800 rounded bg-white dark:bg-slate-900">
                                        ...
                                        <div className="p-5 border-t border-gray-100 dark:border-slate-800">
                                            <ul className="list-none">
                                                <li className="inline-block m-0.5">
                                                    <Link href="" className="py-2 px-5 inline-block font-semibold tracking-wide border align-middle duration-500 text-base text-center bg-transparent hover:bg-[#947e03] border-[#947e03] text-[#947e03] hover:text-white rounded-full">Indigo</Link>
                                                </li>
                                    ...
                                    <div className="shadow-sm dark:shadow-slate-800 rounded bg-white dark:bg-slate-900">
                                        ...
                                        <div className="p-5 border-t border-gray-100 dark:border-slate-800">
                                            <ul className="list-none">
                                                <li className="inline-block m-0.5">
                                                    <Link href="" className="py-2 px-5 inline-block font-semibold tracking-wide border align-middle duration-500 text-base text-center bg-[#947e03]/5 hover:bg-[#947e03] border-[#947e03]/10 hover:border-[#947e03] text-[#947e03] hover:text-white rounded-md">Indigo</Link>
                                                </li>
                                    ...
                                    <div className="shadow-sm dark:shadow-slate-800 rounded bg-white dark:bg-slate-900">
                                        ...
                                        <div className="p-5 border-t border-gray-100 dark:border-slate-800">
                                            <ul className="list-none">
                                                <li className="inline-block m-0.5">
                                                    <Link href="" className="py-2 px-5 inline-block font-semibold tracking-wide border align-middle duration-500 text-base text-center bg-[#947e03]/5 hover:bg-[#947e03] border-[#947e03]/10 hover:border-[#947e03] text-[#947e03] hover:text-white rounded-full">Indigo</Link>
                                                </li>
                                    ...
                                    <div className="shadow-sm dark:shadow-slate-800 rounded bg-white dark:bg-slate-900">
                                        ...
                                        <div className="p-5 border-t border-gray-100 dark:border-slate-800">
                                            <ul className="list-none">
                                                <li className="inline-block m-0.5">
                                                    <Link href="" className="py-[5px] px-4 inline-block font-semibold tracking-wide align-middle duration-500 text-sm text-center bg-[#947e03] hover:bg-indigo-700 border-[#947e03] hover:border-indigo-700 text-white rounded-md">Small</Link>
                                                </li>
                
                                                <li className="inline-block m-0.5">
                                                    <Link href="" className="py-2 px-5 inline-block font-semibold tracking-wide border align-middle duration-500 text-base text-center bg-[#947e03] hover:bg-indigo-700 border-[#947e03] hover:border-indigo-700 text-white rounded-md">Default</Link>
                                                </li>
                
                                                <li className="inline-block m-0.5">
                                                    <Link href="" className="py-2.5 px-8 inline-block font-semibold tracking-wide border align-middle duration-500 text-lg text-center bg-[#947e03] hover:bg-indigo-700 border-[#947e03] hover:border-indigo-700 text-white rounded-md">Large</Link>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                                    ...
                                    <div className="shadow-sm dark:shadow-slate-800 rounded bg-white dark:bg-slate-900">
                                        ...
                                        <div className="p-5 border-t border-gray-100 dark:border-slate-800">
                                            <ul className="list-none">
                                                <li className="inline-block m-0.5">
                                                    <Link href="" className="size-9 inline-flex items-center justify-center tracking-wide align-middle duration-500 text-base text-center rounded-md bg-[#947e03] hover:bg-indigo-700 border border-[#947e03] hover:border-indigo-700 text-white"><Icon.ShoppingCart className="size-4"/></Link>
                                                </li>
                                                
                                                <li className="inline-block m-0.5">
                                                    <Link href="" className="size-9 inline-flex items-center justify-center tracking-wide align-middle duration-500 text-base text-center rounded-full bg-[#947e03] hover:bg-indigo-700 border border-[#947e03] hover:border-indigo-700 text-white"><Icon.ShoppingCart className="size-4"/></Link>
                                                </li>
                                                
                                                <li className="inline-block m-0.5">
                                                    <Link href="" className="size-9 inline-flex items-center justify-center tracking-wide align-middle duration-500 text-base text-center rounded-md border bg-transparent hover:bg-[#947e03] border-[#947e03] text-[#947e03] hover:text-white"><Icon.ShoppingCart className="size-4"/></Link>
                                                </li>
                                                
                                                <li className="inline-block m-0.5">
                                                    <Link href="" className="size-9 inline-flex items-center justify-center tracking-wide align-middle duration-500 text-base text-center rounded-full border bg-transparent hover:bg-[#947e03] border-[#947e03] text-[#947e03] hover:text-white"><Icon.ShoppingCart className="size-4"/></Link>
                                                </li>
                                                ...
                                                <li className="inline-block m-0.5">
                                                    <Link href="" className="size-9 inline-flex items-center justify-center tracking-wide align-middle duration-500 text-base text-center rounded-md border bg-[#947e03]/5 hover:bg-[#947e03] border-[#947e03]/10 hover:border-[#947e03] text-[#947e03] hover:text-white"><Icon.ShoppingCart className="size-4"/></Link>
                                                </li>
                                                
                                                <li className="inline-block m-0.5">
                                                    <Link href="" className="size-9 inline-flex items-center justify-center tracking-wide align-middle duration-500 text-base text-center rounded-full border bg-[#947e03]/5 hover:bg-[#947e03] border-[#947e03]/10 hover:border-[#947e03] text-[#947e03] hover:text-white"><Icon.ShoppingCart className="size-4"/></Link>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                                ...
                                <div className="grid grid-cols-1 gap-[30px]">
                                        ...
                                        <div className="p-5 border-t border-gray-100 dark:border-slate-800">
                                            <ul className="list-none space-x-1">
                                                <li className="inline-block">
                                                    <span className="bg-[#947e03] text-white text-[12px] font-semibold px-2.5 py-0.5 rounded h-5">Indigo</span>
                                                </li>
                                    ...
                                    <div className="shadow-sm dark:shadow-slate-800 rounded bg-white dark:bg-slate-900">
                                        ...
                                        <div className="p-5 border-t border-gray-100 dark:border-slate-800">
                                            <ul className="list-none space-x-1">
                                                <li className="inline-block">
                                                    <span className="bg-[#947e03] text-white text-[12px] font-semibold px-2.5 py-0.5 rounded-full h-5">Indigo</span>
                                                </li>
                                    ...
                                    <div className="shadow-sm dark:shadow-slate-800 rounded bg-white dark:bg-slate-900">
                                        ...
                                        <div className="p-5 border-t border-gray-100 dark:border-slate-800">
                                            <ul className="list-none space-x-1">
                                                <li className="inline-block">
                                                    <span className="bg-transparent border border-[#947e03] text-[#947e03] text-[12px] font-semibold px-2.5 py-0.5 rounded h-5">Indigo</span>
                                                </li>
                                    ...
                                    <div className="shadow-sm dark:shadow-slate-800 rounded bg-white dark:bg-slate-900">
                                        ...
                                        <div className="p-5 border-t border-gray-100 dark:border-slate-800">
                                            <ul className="list-none space-x-1">
                                                <li className="inline-block">
                                                    <span className="bg-transparent border border-[#947e03] text-[#947e03] text-[12px] font-semibold px-2.5 py-0.5 rounded-full h-5">Indigo</span>
                                                </li>
                                    ...
                                    <div className="shadow-sm dark:shadow-slate-800 rounded bg-white dark:bg-slate-900">
                                        ...
                                        <div className="p-5 border-t border-gray-100 dark:border-slate-800">
                                            <ul className="list-none space-x-1">
                                                <li className="inline-block">
                                                    <span className="bg-[#947e03]/5 border border-[#947e03]/5 text-[#947e03] text-[12px] font-semibold px-2.5 py-0.5 rounded h-5">Indigo</span>
                                                </li>
                                    ...
                                    <div className="shadow-sm dark:shadow-slate-800 rounded bg-white dark:bg-slate-900">
                                        ...
                                        <div className="p-5 border-t border-gray-100 dark:border-slate-800">
                                            <ul className="list-none space-x-1">
                                                <li className="inline-block">
                                                    <span className="bg-[#947e03]/5 border border-[#947e03]/5 text-[#947e03] text-[12px] font-semibold px-2.5 py-0.5 rounded-full h-5">Indigo</span>
                                                </li>
                            ...
                            <div className="" id="alerts">
                                ...
                                <div className="grid grid-cols-1 gap-6">
                                    <div className="shadow-sm dark:shadow-slate-800 rounded bg-white dark:bg-slate-900">
                                        ...
                                        <div className="p-5 border-t border-gray-100 dark:border-slate-800">
                                            <div className="space-y-3">
                                                <div className="relative px-4 py-2 rounded-md font-medium bg-[#947e03] border border-[#947e03] text-white block">A simple alert—check it out!</div>
                                    ...
                                    <div className="shadow-sm dark:shadow-slate-800 rounded bg-white dark:bg-slate-900">
                                        ...
                                        <div className="p-5 border-t border-gray-100 dark:border-slate-800">
                                            <div className="space-y-3">
                                                <div className="relative px-4 py-2 rounded-md font-medium bg-[#947e03]/10 border border-[#947e03]/10 text-[#947e03] block">A simple alert—check it out!</div>
                                    ...
                                    <div className="shadow-sm dark:shadow-slate-800 rounded bg-white dark:bg-slate-900">
                                        ...
                                        <div className="p-5 border-t border-gray-100 dark:border-slate-800">
                                            <div className="space-y-3">
                                                <div className="relative px-4 py-2 rounded-md font-medium bg-[#947e03]/10 border border-[#947e03]/10 text-[#947e03] flex items-center"><AiOutlineExclamationCircle className=" me-1"/> A simple alert—check it out!</div>
                                    ...
                                    <div className="shadow-sm dark:shadow-slate-800 rounded bg-white dark:bg-slate-900">
                                        ...
                                        <div className="p-5 border-t border-gray-100 dark:border-slate-800">
                                            <div className="space-y-3">
                                                <div className="relative px-4 py-2 rounded-md font-medium bg-[#947e03]/10 border border-[#947e03]/10 text-[#947e03] block">A simple alert—check it out! <Link href="" className="font-bold ms-1">Click here!</Link></div>
                                ...
                                <div className="grid grid-cols-1 gap-[30px]">
                                        ...
                                        <div className="p-5 border-t border-gray-100 dark:border-slate-800">
                                            <ul className="list-none">
                                                <li className="dropdown inline-block relative m-0.5">
                                                    <button onClick={() => setManu1(!manu1)} className="dropdown-toggle py-2 px-5 inline-block font-semibold tracking-wide border align-middle duration-500 text-base text-center bg-[#947e03] hover:bg-indigo-700 border-[#947e03] hover:border-indigo-700 text-white rounded-md" type="button">
                                                    ...
                                                    <div className={`dropdown-menu absolute start-0 m-0 z-10 w-48 rounded-md overflow-hidden bg-white dark:bg-slate-900 shadow-sm dark:shadow-gray-800 ${manu1 ? 'block' : 'hidden'}`} >
                                                        <ul className="py-2 text-start">
                                                            <li>
                                                                <Link href="" className="block font-medium py-1.5 px-4 hover:text-[#947e03]">Home</Link>
                                                            </li>
                                                            <li>
                                                                <Link href="" className="block font-medium py-1.5 px-4 hover:text-[#947e03]">Service</Link>
                                                            </li>
                                                            <li>
                                                                <Link href="" className="block font-medium py-1.5 px-4 hover:text-[#947e03]">About us</Link>
                                                            </li>
                                                            <li className="border-t border-gray-100 dark:border-gray-800 my-2"></li>
                                                            <li>
                                                                <Link href="" className="block font-medium py-1.5 px-4 hover:text-[#947e03]">Contact</Link>
                                                            </li>
                                                        </ul>
                                                    </div>
                                                </li>
                                    ...
                                    <div className="shadow-sm dark:shadow-slate-800 rounded bg-white dark:bg-slate-900">
                                        ...
                                        <div className="p-5 border-t border-gray-100 dark:border-slate-800">
                                            <ul className="list-none">
                                                <li className="dropdown inline-block relative m-0.5">
                                                    <button onClick={() => setManu11(!manu11)} className="dropdown-toggle size-9 inline-flex items-center justify-center tracking-wide border align-middle duration-500 text-base text-center bg-[#947e03] hover:bg-indigo-700 border-[#947e03] hover:border-indigo-700 text-white rounded-md" type="button">
                                                        <AiOutlineSetting/>
                                                    </button>
                                ...
                                <div className="grid grid-cols-1 gap-[30px]">
                                    <div className="shadow-sm dark:shadow-slate-800 rounded bg-white dark:bg-slate-900">
                                        ...
                                        <div className="p-5 border-t border-gray-100 dark:border-slate-800">
                                            <ul className="list-none">
                                                <li>
                                                    <span className="text-[#947e03] font-semibold">.text-[#947e03]</span>
                                                </li>
                                                <li>
                            ...
                            <div className="" id="backgrounds">
                                ...
                                <div className="grid grid-cols-1 gap-[30px]">
                                    <div className="shadow-sm dark:shadow-slate-800 rounded bg-white dark:bg-slate-900">
                                        ...
                                        <div className="p-5 border-t border-gray-100 dark:border-slate-800">
                                            <ul className="list-none">
                                                <li className="inline-block shadow-sm dark:shadow-gray-800 rounded-md py-2 px-3 m-0.5 text-white bg-[#947e03]">.bg-[#947e03]</li>
                                    ...
                                    <div className="shadow-sm dark:shadow-slate-800 rounded bg-white dark:bg-slate-900">
                                        ...
                                        <div className="p-5 border-t border-gray-100 dark:border-slate-800">
                                            <ul className="list-none">
                                                <li className="inline-block shadow-sm dark:shadow-gray-800 rounded-md py-2 px-3 m-0.5 bg-[#947e03]">.bg-[#947e03]</li>
                                                <li className="inline-block shadow-sm dark:shadow-gray-800 rounded-md py-2 px-3 m-0.5 bg-[#947e03]/95">.bg-[#947e03] .opacity-95</li>
                                                <li className="inline-block shadow-sm dark:shadow-gray-800 rounded-md py-2 px-3 m-0.5 bg-[#947e03]/90">.bg-[#947e03] .opacity-90</li>
                                                <li className="inline-block shadow-sm dark:shadow-gray-800 rounded-md py-2 px-3 m-0.5 bg-[#947e03]/80">.bg-[#947e03] .opacity-80</li>
                                                <li className="inline-block shadow-sm dark:shadow-gray-800 rounded-md py-2 px-3 m-0.5 bg-[#947e03]/75">.bg-[#947e03] .opacity-75</li>
                                                <li className="inline-block shadow-sm dark:shadow-gray-800 rounded-md py-2 px-3 m-0.5 bg-[#947e03]/70">.bg-[#947e03] .opacity-70</li>
                                                <li className="inline-block shadow-sm dark:shadow-gray-800 rounded-md py-2 px-3 m-0.5 bg-[#947e03]/60">.bg-[#947e03] .opacity-60</li>
                                                <li className="inline-block shadow-sm dark:shadow-gray-800 rounded-md py-2 px-3 m-0.5 bg-[#947e03]/50">.bg-[#947e03] .opacity-50</li>
                                                <li className="inline-block shadow-sm dark:shadow-gray-800 rounded-md py-2 px-3 m-0.5 bg-[#947e03]/40">.bg-[#947e03] .opacity-40</li>
                                                <li className="inline-block shadow-sm dark:shadow-gray-800 rounded-md py-2 px-3 m-0.5 bg-[#947e03]/30">.bg-[#947e03] .opacity-30</li>
                                                <li className="inline-block shadow-sm dark:shadow-gray-800 rounded-md py-2 px-3 m-0.5 bg-[#947e03]/25">.bg-[#947e03] .opacity-25</li>
                                                <li className="inline-block shadow-sm dark:shadow-gray-800 rounded-md py-2 px-3 m-0.5 bg-[#947e03]/20">.bg-[#947e03] .opacity-20</li>
                                                <li className="inline-block shadow-sm dark:shadow-gray-800 rounded-md py-2 px-3 m-0.5 bg-[#947e03]/10">.bg-[#947e03] .opacity-10</li>
                                                <li className="inline-block shadow-sm dark:shadow-gray-800 rounded-md py-2 px-3 m-0.5 bg-[#947e03]/5">.bg-[#947e03] .opacity-5</li>
                                                <li className="inline-block shadow-sm dark:shadow-gray-800 rounded-md py-2 px-3 m-0.5 bg-[#947e03]/0">.bg-[#947e03] .opacity-0</li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div className="p-5 border-t border-gray-100 dark:border-slate-800">
                                            <ul className="inline-block w-fit mx-auto flex-wrap justify-center text-center p-2 bg-white dark:bg-slate-900 shadow-sm dark:shadow-gray-800 rounded-md ">
                                                <li role="presentation" className="inline-block">
                                                    <button className={`${ isOpen === 0 ? 'text-white bg-[#947e03] hover:text-white' : ''} px-4 py-1 text-sm font-semibold rounded-md w-full hover:text-[#947e03] duration-500`} onClick={() => handleTabClick(0)}>Tab One</button>
                                                </li>
                                                <li role="presentation" className="inline-block">
                                                    <button className={`${ isOpen === 1 ? 'text-white bg-[#947e03] hover:text-white' : ''} px-4 py-1 text-sm font-semibold rounded-md w-full hover:text-[#947e03] duration-500`} onClick={() => handleTabClick(1)} >Tab Two</button>
                                                </li>
                                            </ul>
                                                ...
                                                <div className="lg:col-span-4 md:col-span-5">
                                                    <ul className="flex-column text-center space-y-2">
                                                        <li role="presentation">
                                                            <button className={`${ isOpen1 === 0 ? 'text-white bg-[#947e03] hover:text-white' : ''} px-4 py-1 text-sm font-semibold rounded-md w-full hover:text-[#947e03] duration-500`} onClick={() => handleTabClick1(0)}>Tab One</button>
                                                        </li>
                                                        <li role="presentation">
                                                            <button className={`${ isOpen1 === 1 ? 'text-white bg-[#947e03] hover:text-white' : ''} px-4 py-1 text-sm font-semibold rounded-md w-full hover:text-[#947e03] duration-500`} onClick={() => handleTabClick1(1)}>Tab Two</button>
                                                        </li>
                                                    </ul>
                                                </div>
                                                ...
                                                <div className="grid grid-cols-1 gap-5">
                                                    ...
                                                    <div className="">
                                                        ...
                                                        <div className="block">
                                                            <div>
                                                                <label className="inline-flex items-center">
                                                                    <input type="radio" className="form-radio border-gray-200 dark:border-gray-800 text-[#947e03] focus:border-indigo-300 focus:ring focus:ring-offset-0 focus:ring-indigo-200 focus:ring-opacity-50 me-2" defaultChecked name="radio-colors" value="1"/>
                                                        ...
                                                        <div className="block mt-2">
                                                            <div>
                                                                <label className="inline-flex items-center">
                                                                    <input type="radio" className="form-radio border-gray-200 dark:border-gray-800 text-[#947e03] focus:border-indigo-300 focus:ring focus:ring-offset-0 focus:ring-indigo-200 focus:ring-opacity-50 me-2" name="radio-colors" value="1"/>
                                                        ...
                                                        <div className="block mt-2">
                                                            <div>
                                                                <label className="inline-flex items-center">
                                                                    <input type="radio" className="form-radio border-gray-200 dark:border-gray-800 text-[#947e03] focus:border-indigo-300 focus:ring focus:ring-offset-0 focus:ring-indigo-200 focus:ring-opacity-50 me-2" disabled name="radio-colors" value="1"/>
                                    ...
                                    <div className="shadow-sm dark:shadow-slate-800 rounded bg-white dark:bg-slate-900">
                                        ...
                                        <div className="p-5 border-t border-gray-100 dark:border-slate-800">
                                            <ul className="tracking-[0.5px] mb-0 inline-flex items-center">
                                                <li className="inline-block uppercase text-[13px] font-bold duration-500 ease-in-out hover:text-[#947e03]"><Link href="/">Techwind</Link></li>
                                                ...
                                                <li className="inline-block uppercase text-[13px] font-bold duration-500 ease-in-out hover:text-[#947e03]"><Link href="">Components</Link></li>
                                                <li className="inline-block text-base text-slate-950 dark:text-white mx-0.5 ltr:rotate-0 rtl:rotate-180"><MdKeyboardArrowRight/></li>
                                                <li className="inline-block uppercase text-[13px] font-bold text-[#947e03]" aria-current="page">Typography</li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div className="" id="modals">
                                ...
                                <div className="grid grid-cols-1 gap-[30px]">
                                    <div className="shadow-sm dark:shadow-slate-800 rounded bg-white dark:bg-slate-900">
                                        ...
                                        <div className="p-5 border-t border-gray-100 dark:border-slate-800">
                                            <Link href="#" className="py-2 px-5 inline-block font-semibold tracking-wide border align-middle duration-500 text-base text-center bg-[#947e03] hover:bg-indigo-700 border-[#947e03] hover:border-indigo-700 text-white rounded-md" onClick={() => setModal(!modal)}>
                                                Modal
                                            </Link>
                                                ...
                                                <div className="relative w-full h-auto max-w-lg p-4">
                                                    <div className="relative bg-white dark:bg-slate-900 rounded-lg shadow-sm dark:shadow-gray-800">
                                                        ...
                                                        <div className="p-6 py-10 text-center">
                                                            ...
                                                            <Link href="" className="py-[5px] px-4 inline-block font-semibold tracking-wide align-middle duration-500 text-sm text-center bg-transparent hover:bg-[#947e03] border border-[#947e03] text-[#947e03] hover:text-white rounded-md mt-2">Create a new wishlist</Link>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <table className="w-full text-start">
                                                    ...
                                                    <tbody>
                                                        <tr className="border-t border-gray-100 dark:border-gray-700">
                                                            ...
                                                            <td className="p-4 text-end"><span className="bg-[#947e03]/5 text-[#947e03] text-xs font-bold px-2.5 py-0.5 rounded h-5">Watch Free</span></td>
                                                        </tr>
                                ...
                                <div className="grid grid-cols-1 gap-[30px]">
                                    <div className="shadow-sm dark:shadow-slate-800 rounded bg-white dark:bg-slate-900">
                                        ...
                                        <div className="p-5 border-t border-gray-100 dark:border-slate-800">
                                            ...
                                            <p className="text-slate-400">There are 280+ feather icons and you can get all icons info from here: <Link href="https://feathericons.com/" target="_blank"><code className="text-[#947e03]">https://feathericons.com/</code></Link></p>
                                            ...
                                            <p className="text-slate-400">There are 4400+ Material Design icons and you can get all icons info from here: <Link href="https://materialdesignicons.com/" target="_blank"><code className="text-[#947e03]">https://materialdesignicons.com/</code></Link></p>
                                            ...
                                            <p className="text-slate-400">There are 2200+ React Icons and you can get all icons info from here: <Link href="https://react-icons.github.io/react-icons/search" target="_blank"><code className="text-[#947e03]">https://react-icons.github.io/react-icons/search</code></Link></p>
                                            <h6 className="text-slate-400 mb-4 pb-2">Ex. <code className="text-red-600"><br/>&lt;FaBeer className= &quot; size-7 &quot; /&gt;</code></h6>
                                            <span className="text-lg text-[#947e03] me-2"><TbPhotoPlus className="inline"/></span>
                                            <span className="text-lg text-[#947e03] me-2 "><AiOutlineAndroid className="inline"/></span>
                                            <span className="text-lg text-[#947e03] me-2"><RiBitCoinLine className="inline"/></span>
                                            <span className="text-lg text-[#947e03] me-2"><MdOutlineCalendarMonth className="inline"/></span>
                                            <span className="text-lg text-[#947e03]"><AiOutlinePieChart className="inline"/></span>
                                        </div>
                                    </div>
                                </div>
                            </div>
