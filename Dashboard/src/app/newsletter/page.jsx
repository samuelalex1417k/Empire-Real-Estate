...
import AddNewsletterContent from "../components/add-newsletter";
      ...
      <div className="container-fluid relative px-3" ref={containerRef}>
        <div className="layout-specing">
          <div className="md:flex justify-between items-center">
            ...
            <Link href="/newsletter-add" className="inline-flex items-center space-x-2 bg-[#947e03] text-white px-4 py-2 rounded hover:bg-[#826d02] transition">
